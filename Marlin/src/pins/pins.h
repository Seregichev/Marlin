...
//
  ...
  #include "stm32f4/pins_MKS_ROBIN_NANO_V1_3_F4.h" // STM32F4                             env:mks_robin_nano_v1_3_f4 env:mks_robin_nano_Sv1_3_f4_x16_flyingbear_ghost5 env:mks_robin_nano_v1_3_f4_x32_flyingbear_reborn
#elif MB(MKS_EAGLE)
